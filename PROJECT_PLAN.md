...
- [ ] 打磨-44（候选）：收集进度一览 点击直达 — 4 类 + 总计 5 条目前纯展示, 玩家点某类想快速查看该列表要手动切 Tab; 每条 label/bar 加可点击 (整行加 Button 或 _gui_input), 技能/装备/法器 点击切到对应 Tab 并联动筛选 (点击 技能 切技能页, 装备 切装备页, 法器 切修行页法器区), 总计 点击展开 tooltip 说明或不做; 保持 悬停 tooltip 不变, 点击不产生存档/统计副作用
