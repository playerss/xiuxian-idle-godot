...
- [ ] 打磨-43（候选）：收集进度一览加 总计 mini 进度条（打磨-42 后横排只有 4 类, 打磨-28 旧文字里的 "(总 N/287)" 汇总失去展示位, 长线玩家不知离 287 全收集还有多远; 在 4 类后加 第 5 条 总计 mini 进度条 (总 N/287, 口径=四类已收集之和/四类总量之和, 金/青 二态与 4 类同 _refresh_collect 口径); _collect_items 加 "total" 条目, ui_test 补断言 5 条节点/总计=10/287 与 137/287 两态, 头宽不足时整排换行 (HBox wrap) 不截断; headless 0 报错 + ui_test + selftest 549 + stress 613 回归, 顺带 4 张截图 Xvfb 重跑)
