...
- [ ] 打磨-46（候选）：一键系列按钮 tooltip 统一说明 — 五个一键按钮 (一键领悟/一键施展/法器一键购买/装备一键购买/一键最佳) 现 tooltip 只讲"做什么", 未说明 筛选叠加口径/购买顺序/自动穿戴规则; 统一 tooltip 格式 "按 X 顺序连买 买得起 的 Y (N 件可执行); 筛选叠加: 类别/品质 AND" (按按钮各自口径), 供玩家预期点击结果
