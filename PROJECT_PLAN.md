...
- [ ] 打磨-52（候选）：装备 一键购买/一键最佳 浮动文案追加 灵气速率变化量（与 打磨-51 法器 一键购买 浮动口径对齐: 装备购买/换装后 灵气速率 (功法装备段 1+Σ 变化) 变化量 "+N/秒" 追加 浮动文案, 0 变化省略, 装备按钮 tooltip 补口径; GameData 无新接口 (qi_per_sec 前后差), selftest/ui_test 补断言）
